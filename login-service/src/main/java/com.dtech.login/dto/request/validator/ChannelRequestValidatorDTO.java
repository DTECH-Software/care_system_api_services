...
@Conditional(selected = "message" , values = {"SIGN_IN","PASSWORD_RESET_REQUEST","PASSWORD_RESET","PASSWORD_RESET_OTP_VALIDATION"} ,required = {"username"} ,message = "Username is required.")
