...
public interface InsuranceClaimsAccountBalanceRepository extends JpaRepository<InsuranceClaimsAccountBalance, Long> {
  //  Optional<InsuranceClaimsAccountBalance> findByEmployeeAndTreatmentAndInsurancePeriod(ApplicationUser user, Treatment treatment, InsuranceYear insuranceYear);
}
