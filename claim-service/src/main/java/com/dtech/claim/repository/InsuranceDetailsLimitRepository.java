...
public interface InsuranceDetailsLimitRepository extends JpaRepository<InsuranceDetailsLimit, Long> {
    ...
    Optional<InsuranceDetailsLimit> findFirstByStatusAndInsuranceStaffCategoryPeriodAndTreatment_TreatmentCode(
            Status status,
    ...
    List<InsuranceDetailsLimit> findByStatusAndInsuranceStaffCategoryPeriod(Status status,
                                                                            InsuranceStaffCategoryPeriod insuranceYear);
