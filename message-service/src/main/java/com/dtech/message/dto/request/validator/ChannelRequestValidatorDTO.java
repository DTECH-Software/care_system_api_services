...
import com.dtech.message.enums.Channel;
...
@Conditional(selected = "message", values = {"RESET_PASSWORD_OTP_REQUEST","RESET_PASSWORD_OTP_VALIDATION",
        "CLAIM_REQUEST_OTP_REQUEST","CLAIM_REQUEST_OTP_VALIDATION",
        "PROFILE_UPDATE_OTP_REQUEST","PROFILE_UPDATE_OTP_VALIDATION"}, required = {"username"}, message = "Username is required.")
