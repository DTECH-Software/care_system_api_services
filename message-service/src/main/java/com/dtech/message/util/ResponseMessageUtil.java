...
public class ResponseMessageUtil {
    /*Signup*/
    public final static String EMPLOYEE_DETAILS_NOT_FOUND_ON_SYSTEM = "val.employee.details.not.found";
    public final static String EMPLOYEE_ALREADY_SIGN_UP = "val.employee.already.signup";
    ...
    /*Message*/
    public final static String NOTIFICATION_TEMPLATE_NOT_FOUND = "val.notification.template.not.found";
