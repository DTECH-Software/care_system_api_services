...
@Entity
@Table(name = "application_password_policy")
@Data
public class ApplicationPasswordPolicy extends Audit implements Serializable {
    ...
    @Column(name = "onboarding_otp_history",nullable = false,length = 2)
    private int onboardingOtpHistory;
